<?php
    // HTML Content for the sticky header section
    echo '
    <div id="sticky-container">
    <div id="sticky" class="stickyState animated slideInDown"> <!-- The header thats slides down with you on the page-->
              ...
              <div class="flex-space-between">
                  ...
                  <div class="actions">
                    <div class="container-hamburger">
                      <button type="button" id="sticky-hamburger" class="btn btn-sticky btn-hamburger hamburger  is-active">
                  ...
                  <a>
                    ...
                    <div class="sub-menu-banner-dc">
                      <ul class="container sub-menu" role="menu">
                        ...
                        <li class="sub-menu-banner-item">
                          <a>
                            <span class="link-icon-container icon-help"></span>
